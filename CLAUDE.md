...
```bash
remotediff mac-studio:Development/growthq/portal                    # basic
remotediff ernesto@mac-studio:Development/growthq/portal            # with SSH user
remotediff mac-studio:Development/growthq/portal --ref main         # custom ref
